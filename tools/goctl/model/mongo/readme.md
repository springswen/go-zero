...
* usermodel.go
  ...
  import (
      ...
      cachec "github.com/springswen/go-zero/core/stores/cache"
      "github.com/springswen/go-zero/core/stores/mongoc"
  )
...
OPTIONS:
   ...
   --style value           the file naming format, see [https://github.com/springswen/go-zero/tree/master/tools/goctl/config/readme.md]
