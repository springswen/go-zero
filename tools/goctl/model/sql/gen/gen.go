...
import (
	...
	"github.com/springswen/go-zero/tools/goctl/config"
	"github.com/springswen/go-zero/tools/goctl/model/sql/model"
	"github.com/springswen/go-zero/tools/goctl/model/sql/parser"
	"github.com/springswen/go-zero/tools/goctl/model/sql/template"
	modelutil "github.com/springswen/go-zero/tools/goctl/model/sql/util"
	"github.com/springswen/go-zero/tools/goctl/util"
	"github.com/springswen/go-zero/tools/goctl/util/console"
	"github.com/springswen/go-zero/tools/goctl/util/format"
	"github.com/springswen/go-zero/tools/goctl/util/stringx"
)
