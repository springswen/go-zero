...
import (
	...
	"github.com/springswen/go-zero/core/load"
	"github.com/springswen/go-zero/core/logx"
	"github.com/springswen/go-zero/core/stat"
	"github.com/springswen/go-zero/tools/goctl/api/apigen"
	"github.com/springswen/go-zero/tools/goctl/api/dartgen"
	"github.com/springswen/go-zero/tools/goctl/api/docgen"
	"github.com/springswen/go-zero/tools/goctl/api/format"
	"github.com/springswen/go-zero/tools/goctl/api/gogen"
	"github.com/springswen/go-zero/tools/goctl/api/javagen"
	"github.com/springswen/go-zero/tools/goctl/api/ktgen"
	"github.com/springswen/go-zero/tools/goctl/api/new"
	"github.com/springswen/go-zero/tools/goctl/api/tsgen"
	"github.com/springswen/go-zero/tools/goctl/api/validate"
	"github.com/springswen/go-zero/tools/goctl/configgen"
	"github.com/springswen/go-zero/tools/goctl/docker"
	"github.com/springswen/go-zero/tools/goctl/kube"
	"github.com/springswen/go-zero/tools/goctl/model/mongo"
	model "github.com/springswen/go-zero/tools/goctl/model/sql/command"
	"github.com/springswen/go-zero/tools/goctl/plugin"
	rpc "github.com/springswen/go-zero/tools/goctl/rpc/cli"
	"github.com/springswen/go-zero/tools/goctl/tpl"
	"github.com/springswen/go-zero/tools/goctl/upgrade"
			...
			Subcommands: []cli.Command{
				...
				},
				{
					...
					Flags: []cli.Flag{
						...
						cli.StringFlag{
							Name:  "style",
							Usage: "the file naming format, see [https://github.com/springswen/go-zero/tree/master/tools/goctl/config/readme.md]",
						},
						cli.StringFlag{
							Name:  "home",
