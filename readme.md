<img align="right" width="150px" src="https://raw.githubusercontent.com/springswen/zero-doc/main/doc/images/go-zero.png">
...
<img src="https://raw.githubusercontent.com/springswen/zero-doc/main/doc/images/architecture-en.png" alt="Architecture" width="1500" />
...
![Resilience](https://raw.githubusercontent.com/springswen/zero-doc/main/doc/images/resilience-en.png)
...
```shell
go get -u github.com/springswen/go-zero
```
...
0. full examples can be checked out from below:
     ...
     [Rapid development of microservice systems](https://github.com/springswen/zero-doc/blob/main/doc/shorturl-en.md)

     [Rapid development of microservice systems - multiple RPCs](https://github.com/springswen/zero-doc/blob/main/docs/zero/bookstore-en.md)
...
1. install goctl
   ...
   ```shell
   GO111MODULE=on go get -u github.com/springswen/go-zero/tools/goctl
   ```
